(function () {
  ...
  ApplicationLoginpageController.$inject = ['Config', '$sce', '$mdDialog', 'Toast', 'application', 'ApplicationService'];

  /**
   * ApplicationLoginpageController constructor
   */
  function ApplicationLoginpageController(Config, $sce, $mdDialog, Toast, application, ApplicationService) {
    var vm = this;
