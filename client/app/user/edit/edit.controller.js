/**
 * @ngdoc controller
 * @name austackApp.admin.user.list.edit.controller:UserEditController
 * @description
...
(function () {
  ...
  /**
   * @ngdoc function
   * @name austackApp.admin.user.list.edit.provider:UserEditController
   * @description
   * Provider of the {@link austackApp.admin.user.list.edit.controller:UserEditController UserEditController}
  ...
  function UserEditController($state, $stateParams, Toast, $mdDialog, Auth, UserService, user) {
    ...
    function update(form) {
      ...
      function updateUserSuccess(updatedUser) {
        ...
        Toast.show({
          text: 'User ' + updatedUser.name + ' updated'
        });
        if (form) {
          form.$setPristine();
        }
    ...
    function remove(form, ev) {
      ...
      function performRemove() {
        ...
        function deleteUserSuccess() {
          Toast.show({
            type: 'success',
            text: 'User ' + vm.displayName + ' deleted'
          });
          vm.showList();
        }
