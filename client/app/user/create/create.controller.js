/**
 * @ngdoc controller
 * @name austackApp.admin.user.create.controller:UserCreateController
 * @description
...
(function () {
  ...
  /**
   * @ngdoc function
   * @name austackApp.admin.user.create.provider:UserCreateController
   * @description
   * Provider of the {@link austackApp.admin.user.create.controller:UserCreateController UserCreateController}
   *
   ...
   * @returns {Service} {@link austackApp.admin.user.create.controller:UserCreateController UserCreateController}
   */
  ...
  function UserCreateController($mdDialog, Auth, User, Toast) {
     ...
     * @ngdoc property
     * @name userRoles
     * @propertyOf austackApp.admin.user.create.controller:UserCreateController
     * @description
     ...
     * @ngdoc function
     * @name create
     * @methodOf austackApp.admin.user.create.controller:UserCreateController
     * @description
