/**
 * @ngdoc controller
 * @name austackApp.admin.user.list.items.controller:UserItemsController
 * @description
...
(function () {
  ...
  /**
   * @ngdoc function
   * @name austackApp.admin.user.list.items.provider:UserItemsController
   * @description
   * Provider of the {@link austackApp.admin.user.list.items.controller:UserItemsController UserItemsController}
   *
   */
