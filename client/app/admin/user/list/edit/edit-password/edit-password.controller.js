/**
 * @ngdoc controller
 * @name austackApp.admin.user.list.edit.controller:EditPasswordController
 * @description
...
(function () {
  ...
  /**
   * @ngdoc function
   * @name austackApp.admin.user.list.edit.provider:EditPasswordController
   * @description
   * Provider of the {@link austackApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
   *
   ...
   * @returns {Service} {@link austackApp.admin.user.list.edit.controller:EditPasswordController EditPasswordController}
   */
  ...
  function EditPasswordController($mdDialog, UserService, user, Toast) {
     ...
     * @ngdoc function
     * @name changePassword
     * @methodOf austackApp.admin.user.list.edit.controller:EditPasswordController
     * @description
